---
title: "CS564 scRNAseq Analysis Pipeline"
author: "Cory Henn"
format: html
editor: visual
---
...
## Run SCType for cell identification
...
## New on PCA similarity

```{r}
# Accessing the PCA embeddings
pca_embeddings <- seurat_object[["pca"]]@cell.embeddings
print(pca_embeddings)
```

```{r}
pca_dist <- dist(pca_embeddings)

# Convert distance object to matrix
cosine_matrix <- as.matrix(pca_dist)
